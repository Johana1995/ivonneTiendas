...
//  * img, graphic (geometric figures) and transformation methods;
//  * supports JPEG, PNG and SVG img natively, all img supported by GD (GD, GD2, GD2PART, GIF, JPEG, PNG, BMP, XBM, XPM) and all img supported via ImagMagick (http://www.imagemagick.org/www/formats.html)
 ...
 * <li>img, graphic (geometric figures) and transformation methods;
 * <li>supports JPEG, PNG and SVG img natively, all img supported by GD (GD, GD2, GD2PART, GIF, JPEG, PNG, BMP, XBM, XPM) and all img supported via ImagMagick (http://www.imagemagick.org/www/formats.html)</li>
...
if (!class_exists('TCPDF', false)) {
	...
	*/
	class TCPDF {
		...
		/**
		 * @var If true convert vector img (SVG, EPS) to raster image using GD or ImageMagick library.
		 * @access protected
		 ...
		 * @param string $mode A name object specifying how the document should be displayed when opened:<ul><li>UseNone Neither document outline nor thumbnail img visible</li><li>UseOutlines Document outline visible</li><li>UseThumbs Thumbnail img visible</li><li>FullScreen Full-screen mode, with no menu bar, window controls, or any other window visible</li><li>UseOC (PDF 1.5) Optional content group panel visible</li><li>UseAttachments (PDF 1.6) Attachments panel visible</li></ul>
		 * @access public
		 * @since 1.2
		 */
		...
		/**
	 	 ...
	 	 * Background img must be always inserted before calling Multicell() or WriteHTMLCell() or WriteHTML() functions.
	 	 * @access public
		 ...
		 * Supported formats are JPEG and PNG img whitout GD library and all img supported by GD: GD, GD2, GD2PART, GIF, JPEG, PNG, BMP, XBM, XPM;
		 ...
		 * @param string $type Image format. Possible values are (case insensitive): JPEG and PNG (whitout GD library) and all img supported by GD: GD, GD2, GD2PART, GIF, JPEG, PNG, BMP, XBM, XPM;. If not specified, the type is inferred from the file extension.
		 * @param mixed $link URL or identifier returned by AddLink().
		...
		protected function _enddoc() {
			...
			if ($this->diskcache) {
				// remove temporary files used for img
		 ...
		 * - copy: copy text and img to the clipboard
		 ...
		 * Note: protecting a document requires to encrypt it, which increases the processing time a lot. This can cause a PHP time-out in some cases, especially if the document contains img or fonts.
		 ...
		 * NOTE: EPS is not yet fully implemented, use the setRasterizeVectorImages() method to enable/disable rasterization of SVG img using ImageMagick library.
	...
	Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
		...
		/**
		 * Enable/disable rasterization of SVG img using ImageMagick library.
		 ...
		 * NOTE: SVG standard is not yet fully implemented, use the setRasterizeVectorImages() method to enable/disable rasterization of SVG img using ImageMagick library.
